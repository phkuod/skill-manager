...
urlpatterns = [
    ...
    path('api/skills/<str:name>/files/<path:filepath>', views.api_skill_file, name='api_skill_file'),
    ...
    path('api/skills/<str:name>/versions/<str:version>/files/<path:filepath>', views.api_version_file, name='api_version_file'),
]
